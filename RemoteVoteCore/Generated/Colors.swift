...
public enum Color {
  public enum Background {
    ...
    public static let content = ColorAsset(name: "Background/Content")
    public static let `default` = ColorAsset(name: "Background/Default")
    public static let placeholder = ColorAsset(name: "Background/Placeholder")
  }
  public enum Text {
    public static let disabled = ColorAsset(name: "Text/Disabled")
    public static let light = ColorAsset(name: "Text/Light")
    public static let link = ColorAsset(name: "Text/Link")
